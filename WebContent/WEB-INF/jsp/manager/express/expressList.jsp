                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 快递商列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="expressesInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${expressesInfo.expressName}</td>
												<td>${expressesInfo.contacts}</td>
												<td>${expressesInfo.mobile}</td>
												<td>${expressesInfo.telephone}</td>
												<td>${expressesInfo.address}</td>
												<td>${expressesInfo.status}</td>
												<td class="center"><a class="btn btn-success"
													href="initExpressPrice?expressId=${expressesInfo.expressId}"> <i
														class="glyphicon glyphicon-zoom-in icon-white"></i> 价格
												</a> <a class="btn btn-info" href="initEditExpress?expressId=${expressesInfo.expressId}"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 编辑
												</a> <a class="btn btn-danger" onclick="showDialog('delExpress?expressId=${expressesInfo.expressId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddExpress">
