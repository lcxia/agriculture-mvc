                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="expressForm" action="editExpress" method="post">
                                	<form:hidden path="expressId" value="${expressForm.expressId}"/>
                                    ...
                                    <table class="table table-bordered responsive">
                                        <tr>
											...
											<td><form:input path="expressName" cssClass="form-control" value="${expressForm.expressName}" cssErrorClass="form-control error"/></td>
											
											<td style="background-color: #f9f9f9;">联系人<span style="color:red;">*</span></td>
											<td><form:input path="contacts" cssClass="form-control" value="${expressForm.contacts}" cssErrorClass="form-control error"/></td>
										
											<td style="background-color: #f9f9f9;">手机<span style="color:red;">*</span></td>
											<td><form:input path="mobile" cssClass="form-control" value="${expressForm.mobile}" cssErrorClass="form-control error"/></td>
											
										</tr>
										<tr>
											<td style="background-color: #f9f9f9;">传真<span style="color:red;">*</span></td>
											<td><form:input path="fax" cssClass="form-control" value="${expressForm.fax}" cssErrorClass="form-control error"/></td>
											
											<td style="background-color: #f9f9f9;">固定电话<span style="color:red;">*</span></td>
											<td><form:input path="telephone" cssClass="form-control" value="${expressForm.telephone}" cssErrorClass="form-control error"/></td>
											
											<td style="background-color: #f9f9f9;">状态</td>
											<td>
												<div class="controls">
													<form:select path="status" itemValue="${expressForm.status}">
										...
										<tr>
											...
											<td colspan="5"><form:input path="address" cssClass="form-control" value="${expressForm.address}" cssErrorClass="form-control error"/></td>
									
										</tr>
										<tr>
											<td style="background-color: #f9f9f9;">备注</td>
											<td colspan="5"><form:input path="note" cssClass="form-control" value="${expressForm.note}" cssErrorClass="form-control error"/></td>
                                    ...
                                    <div class="input-group has-success col-md-12" align="right">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a class="btn btn-danger"href="initExpress">取 消</a>
                                    </div>
