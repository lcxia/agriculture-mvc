					...
					<div class="box col-md-12">
						<div class="box-inner">
							<div class="box-header well" data-original-title="">
								<h2>
									<i class="glyphicon glyphicon-user"></i> 通知
								</h2>
							...
							<div class="box-content">
								<div class="alert alert-info">分销商享有最低折扣，邮费自理，不包邮。<br/>
								邮费会根据送货省份的不同略有差异，总体趋势是商品越重邮费越高，如果感觉邮费有问题请利用站内留言功能给管理员留言。</div>
							</div>
						</div>
					</div>
					<!--/span-->
