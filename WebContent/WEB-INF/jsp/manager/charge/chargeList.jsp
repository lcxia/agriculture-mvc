                        ...
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="chargesInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${chargesInfo.chargeId}</td>
												<td>${chargesInfo.amount}</td>
												<td>${chargesInfo.distributorId}</td>
												<td>${chargesInfo.chargeDate}</td>
												<td>${chargesInfo.status}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddCharge">
