...
<body>
                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 二维码列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="qrCodesInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${qrCodesInfo.distributorPriceId}</td>
												<td>${qrCodesInfo.commodityName}</td>
												<td>${qrCodesInfo.retailPrice}</td>
												<td><a class="btn btn-info"
													onclick="openWindow(${qrCodesInfo.distributorPriceId});"> <i
	...
	<script type="text/javascript">
		...
		function openWindow(url) {
			window.open('createQrCode?distributorPriceId=' + url, 'QrWindow', 'height=150,width=150,top='+ (window.screen.availHeight-30-150)/2 +',left='+ (window.screen.availWidth-10-150)/2);
		}
