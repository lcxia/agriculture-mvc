...
<body>
                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 商品类型
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="commodityTypesInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${commodityTypesInfo.commodityTypeId}</td>
												<td>${commodityTypesInfo.commodityTypeName}</td>
												<td class="center"><a class="btn btn-info" href="initEditCommodityType?commodityTypeId=${commodityTypesInfo.commodityTypeId}"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 编辑
												</a> <a class="btn btn-danger" onclick="showDialog('delCommodityType?commodityTypeId=${commodityTypesInfo.commodityTypeId}&pictureId=${commodityTypesInfo.commodityTypeId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddCommodityType">
	...
	<script type="text/javascript">
		...
		function openWindow(url) {
			window.open('createQrCode?commodityTypeId=' + url, 'QrWindow', 'height=150,width=150,top='+ (window.screen.availHeight-30-150)/2 +',left='+ (window.screen.availWidth-10-150)/2);
		}
	</script>
</body>
</html>