                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 商品类型信息
                                </h2>
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="commodityTypeForm" action="editCommodityType" method="post">
                                	<form:hidden path="commodityTypeId" value="${CommodityTypeForm.commodityTypeId}"/>
                                	<div class="alert alert-info">${message}<form:errors path="*"></form:errors></div>
                                    <table class="table table-bordered responsive">
                                        <tr>
											<td style="background-color: #f9f9f9;">商品类型ID</td>
											<td>
												${commodityTypeForm.commodityTypeId}
											</td>
											<td style="background-color: #f9f9f9;">商品类型<span style="color:red;">*</span></td>
											...
											<td><input name="note" class="form-control" value="${commodityTypeForm.note}" /></td>
										</tr>
                                    ...
                                    <div class="input-group has-success col-md-12" align="right">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="initCommodityType" class="btn btn-danger">取 消</a>
                                    </div>
