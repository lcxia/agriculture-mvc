                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 站内留言列表
                                </h2>
							...
							<div class="box-content">
                            	<table class="table table-bordered responsive">
                                	<tr>
										<td style="background-color: #f9f9f9;">标题<span style="color:red;">*</span></td>
										<td>${messageForm.title}</td>
									</tr>
									<tr>
										<td style="background-color: #f9f9f9;">内容</td>
										<td>${messageForm.context}</td>
									</tr>
                                </table>
                            </div>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="messageRepliesInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${messageRepliesInfo.context}</td>
												<td>${messageRepliesInfo.replyerId}</td>
												<td>${messageRepliesInfo.updateTime}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="messageReplyForm" action="addMessageReply" method="post">
                                	<form:hidden path="messageId" value="${messageForm.messageId}"/>
                                	<div class="alert alert-info">${message}<form:errors path="*"></form:errors></div>
                                    <table class="table table-bordered responsive">
										<tr>
											<td style="background-color: #f9f9f9;">内容</td>
											<td><textarea name="context" style="WIDTH:930px;HEIGHT:200px;"></textarea></td>
										</tr>
                                    </table>
                                    <div class="input-group has-success col-md-12" align="right">
                                        <button type="submit" class="btn btn-success">提 交</button>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a class="btn btn-danger" href="initMessage"><i class="glyphicon glyphicon-trash icon-white"></i> 取 消</a>
                                    </div>
