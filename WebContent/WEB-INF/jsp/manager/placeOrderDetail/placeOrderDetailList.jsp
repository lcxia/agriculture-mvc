                        ...
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="placeOrderDetailsInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${placeOrderDetailsInfo.commodityName}</td>
												<td>${placeOrderDetailsInfo.brandName}</td>
												<td>${placeOrderDetailsInfo.specifications}</td>
												<td>${placeOrderDetailsInfo.purchaseCount}</td>
												<td>${placeOrderDetailsInfo.benchmarkPrice}</td>
												<td>${placeOrderDetailsInfo.sumAmount}</td>
												<td class="center">
												<c:if test="${placeOrderForm.status == '未提交'}">
													<a class="btn btn-info" href="initEditPlaceOrderDetail?placeOrderDetailId=${placeOrderDetailsInfo.placeOrderDetailId}"> <i
															class="glyphicon glyphicon-edit icon-white"></i> 编辑
													</a> <a class="btn btn-danger" onclick="showDialog('delPlaceOrderDetail?placeOrderDetailId=${placeOrderDetailsInfo.placeOrderDetailId}&placeOrderId=${placeOrderForm.placeOrderId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
										...
										<tr>
											<td colspan="11" align="right">
												...
												<c:if test="${list.size() != 0}">
													<a class="btn btn-info" onclick="showSubmitDialog('submitPlaceOrder?placeOrderId=${placeOrderForm.placeOrderId}')" href="#" data-toggle="modal" data-target="#submitModal">
													<i class="glyphicon glyphicon-zoom-in icon-white"></i> 提交订单
												</a>
												</c:if>
												&nbsp;&nbsp;&nbsp;&nbsp;
												<a class="btn btn-success" href="initAddPlaceOrderDetail?placeOrderId=${placeOrderForm.placeOrderId}">
													<i class="glyphicon glyphicon-zoom-in icon-white"></i> 追加
												</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
												</c:if>
	                                       		<a class="btn btn-danger" href="initPlaceOrder">
