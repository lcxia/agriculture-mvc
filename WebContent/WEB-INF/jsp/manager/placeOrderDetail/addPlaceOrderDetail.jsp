                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="placeOrderDetailForm" action="addPlaceOrderDetail" method="post">
                                    ...
                                    <table class="table table-bordered responsive">
										...
										<tr>
											...
											<td><form:input path="purchaseCount" cssClass="form-control" cssErrorClass="form-control error" value="${placeOrderDetailForm.purchaseCount}"/></td>
