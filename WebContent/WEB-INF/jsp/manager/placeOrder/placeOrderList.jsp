                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 销售订单列表
                                </h2>
                            ...
                            <div class="box-content">
                                ...
                                <table
									...
									<tbody>
										<c:forEach var="placeOrdersInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${placeOrdersInfo.storage}</td>
												<td>${placeOrdersInfo.amount}</td>
												<td>${placeOrdersInfo.guestFrom}</td>
												<td>${placeOrdersInfo.contacts}</td>
												<td>${placeOrdersInfo.mobile}</td>
												<td>${placeOrdersInfo.status}</td>
												<td class="center">
													<c:if test="${placeOrdersInfo.status != '已提交'}">
														<a class="btn btn-success"
															href="initPlaceOrderDetail?placeOrderId=${placeOrdersInfo.placeOrderId}"> <i
																class="glyphicon glyphicon-zoom-in icon-white"></i> 明细
														</a> 
														<c:if test="${placeOrdersInfo.status == '未提交'}">
															<a class="btn btn-info" href="initEditPlaceOrder?placeOrderId=${placeOrdersInfo.placeOrderId}"> <i
																	class="glyphicon glyphicon-edit icon-white"></i> 编辑
															</a> <a class="btn btn-danger" onclick="showDialog('delPlaceOrder?placeOrderId=${placeOrdersInfo.placeOrderId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddPlaceOrder">
