                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="placeOrderForm" action="editPlaceOrder" method="post">
                                	<form:hidden path="placeOrderId" value="${placeOrderForm.placeOrderId}" />
                                	<form:hidden path="amount" value="${placeOrderForm.amount}" />
                                    ...
                                    <table class="table table-bordered responsive">
                                        <tr>
											...
											<td>
												<div class="controls">
													<form:select path="storage" itemValue="${placeOrderForm.storage}">
											...
											<td>
												<div class="controls">
													<form:select path="expressId" itemValue="${placeOrderForm.transportMode}">
											...
											<td>
												<div class="controls">
													<form:select path="guestFrom" itemValue="${placeOrderForm.guestFrom}">
										...
										<tr>
											...
											<td>
												<form:select path="provinceId" itemValue="${placeOrderForm.provinceId}">
											...
											<td>
												<form:select path="cityId" itemValue="${placeOrderForm.cityId}">
										...
										<tr>
											...
											<td><form:input path="orderDate" cssClass="form-control" cssErrorClass="form-control error" value="${placeOrderForm.orderDate}" id="orderDate" data-date-format="yyyy-mm-dd" /></td>
										</tr>
										<tr>
