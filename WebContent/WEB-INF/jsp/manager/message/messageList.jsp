                        ...
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="messagesInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${messagesInfo.title}</td>
												<td>${messagesInfo.distributorId}</td>
												<td>${messagesInfo.updateTime}</td>
												<td class="center"><a class="btn btn-success"
													href="initMessageReply?messageId=${messagesInfo.messageId}"> <i
														class="glyphicon glyphicon-zoom-in icon-white"></i> 查看回复
												</a> <a class="btn btn-danger" onclick="showDialog('delMessage?messageId=${messagesInfo.messageId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddMessage">
