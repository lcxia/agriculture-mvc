                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 留言信息
                                </h2>
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="messageForm" action="addMessage" method="post">
                                	<div class="alert alert-info">${message}<form:errors path="*"></form:errors></div>
                                    <table class="table table-bordered responsive">
                                    	<c:if test="${sessionScope.UVO.admin == 'on'}">
	                                    	<tr>
	                                        	<td style="background-color: #f9f9f9;">分销商<span style="color:red;">*</span></td>
												<td>
													<div class="controls">
														<form:select path="distributorId">
															<form:options id="distributorId" items="${distributorList}" itemLabel="label" itemValue="value" />
														</form:select>
													</div>
												</td>
											</tr>	
										...
										<tr>
											...
											<td><textarea name="context" style="WIDTH:900px;HEIGHT:400px;"></textarea></td>
										</tr>
                                    </table>
