                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 返点列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="rebatesInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${rebatesInfo.distributorId}</td>
												<td>${rebatesInfo.distributorName}</td>
												<td>${rebatesInfo.commodityName}</td>
												<td>${rebatesInfo.benchmarkPrice}</td>
												<td>${rebatesInfo.retailPrice}</td>
												<td>${rebatesInfo.rebateValue}</td>
												<td>${rebatesInfo.isRebate}</td>
												<td>
													<c:if test="${rebatesInfo.isRebate !='已返点'}">
														<a class="btn btn-info"
															href="editRebate?distributorId=${rebatesInfo.distributorId}&rebateValue=${rebatesInfo.rebateValue}&amount=${rebatesInfo.amount}&outTradeNo=${rebatesInfo.outTradeNo}"> <i
																class="glyphicon glyphicon-edit icon-white"></i> 返点
														</a>
													</c:if>
												</td>
											</tr>
