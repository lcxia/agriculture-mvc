                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="stockForm" action="editStock" method="post">
                                	<form:hidden path="stockId" value="${stockForm.stockId}"/>
                                	<div class="alert alert-info">${message}<form:errors path="stock"></form:errors></div>
                                        ...
                                        <tr>
											...
											<td>
												<div class="controls">
												 ...
												 <span>${stockForm.commodityName}</span>
												</div>
											</td>
											...
											<td><input name="note" class="form-control" value="${stockForm.note}" /></td>
										</tr>
                                    ...
                                    <div class="input-group has-success col-md-12" align="right">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="initStock" class="btn btn-danger">取 消</a>
                                    </div>
