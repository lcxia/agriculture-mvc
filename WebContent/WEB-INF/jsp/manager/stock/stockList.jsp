                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 库存列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="stockInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${stockInfo.supplierName}</td>
												<td>${stockInfo.type}</td>
												<td>${stockInfo.brandName}</td>
												<td>${stockInfo.commodityName}</td>
												<td>${stockInfo.specifications}</td>
												<td>${stockInfo.stock}</td>
												<td class="center"><a class="btn btn-info" href="initEditStock?stockId=${stockInfo.stockId}"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 编辑
												</a> <a class="btn btn-danger" onclick="showDialog('delStock?stockId=${stockInfo.stockId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddStock">
