                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 供应商所属品牌信息
                                </h2>
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="brandForm" action="editBrand" method="post">
                                	<form:hidden path="supplierId" value="${brandForm.supplierId}" />
                                	<form:hidden path="brandId" value="${brandForm.brandId}" />
                                	<div class="alert alert-info">${message}<form:errors path="*"></form:errors></div>
                                    <table class="table table-bordered responsive">
                                        <tr>
											<td style="background-color: #f9f9f9;width:10%">品牌名称<span style="color:red">*</span></td>
											<td style="width:25%"><form:input path="brandName"  cssClass="form-control" cssErrorClass="form-control error" value="${brandForm.brandName}" /></td>
											<td style="background-color: #f9f9f9;width:6%">备注</td>
											<td><input name="note" class="form-control" value="${brandForm.note}" /></td>
										</tr>
                                    </table>
                                    <div class="input-group has-success col-md-12" align="right">
                                        <button type="submit" class="btn btn-success">提 交</button>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a href="initBrand?supplierId=${brandForm.supplierId}"><button type="button" class="btn btn-danger">取 消</button></a>
                                    </div>
