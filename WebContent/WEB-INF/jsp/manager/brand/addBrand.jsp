                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="brandForm" action="addBrand" method="post">
                                    ...
                                    <table class="table table-bordered responsive">
                                        <tr>
											...
											<td style="width:25%"><form:input path="brandName" cssclass="form-control" cssErrorClass="form-control error"/></td>
