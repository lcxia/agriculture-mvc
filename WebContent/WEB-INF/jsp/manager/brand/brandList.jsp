                ...
                <div class="row">
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 该供应商所持品牌列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="brandsInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${brandsInfo.brandId}</td>
												<td>${brandsInfo.brandName}</td>
												<td>${brandsInfo.note}</td>
												<td>${brandsInfo.updateUser}</td>
												<td>${brandsInfo.updateTime}</td>
												<td class="center"><a class="btn btn-info" href="initEditBrand?brandId=${brandsInfo.brandId}"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 编辑
												</a> <a class="btn btn-danger" onclick="showDialog('delBrand?supplierId=${brandsInfo.supplierId}&brandId=${brandsInfo.brandId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddBrand?supplierId=${supplierForm.supplierId}">
													<i class="glyphicon glyphicon-zoom-in icon-white"></i> 追加
												</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
	                                       		<a class="btn btn-danger" href="initSupplier">
