                        ...
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                ...
                                <table
									...
									<tbody>
										<c:forEach var="deliveriesInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${deliveriesInfo.storage}</td>
												<td>${deliveriesInfo.amount}</td>
												<td>${deliveriesInfo.userId}</td>
												<td>${deliveriesInfo.contacts}</td>
												<td>${deliveriesInfo.mobile}</td>
												<td>${deliveriesInfo.status}</td>
												<td class="center">
													<c:if test="${deliveriesInfo.status != '未提交'}">
														<a class="btn btn-success"
															href="initDeliveryDetail?placeOrderId=${deliveriesInfo.placeOrderId}"> <i
