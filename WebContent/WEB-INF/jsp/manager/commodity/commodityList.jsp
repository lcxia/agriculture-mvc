...
<body>
                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 商品列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="commoditysInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${commoditysInfo.supplierName}</td>
												<td>${commoditysInfo.commodityTypeName}</td>
												<td>${commoditysInfo.brandName}</td>
												<td>${commoditysInfo.commodityName}</td>
												<td>${commoditysInfo.specifications}</td>
												<td class="center"><a class="btn btn-info" href="initEditCommodity?commodityId=${commoditysInfo.commodityId}"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 编辑
												</a> <a class="btn btn-danger" onclick="showDialog('delCommodity?commodityId=${commoditysInfo.commodityId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
														class="glyphicon glyphicon-trash icon-white"></i> 删除
												</a> <a class="btn btn-info"
													onclick="openWindow(${commoditysInfo.commodityId});"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 生成二维码
												</a> <a class="btn btn-info"
													href="download?commodityId=${commoditysInfo.commodityId}"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 下载附件
												</a></td>
											</tr>
										</c:forEach>
									</tbody>
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddCommodity">
													<i class="glyphicon glyphicon-zoom-in icon-white"></i> 追加
												</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
	                                       		<a class="btn btn-danger" href="initMenu">
	...
	<script type="text/javascript">
		...
		function openWindow(url) {
			window.open('createQrCode?commodityId=' + url, 'QrWindow', 'height=150,width=150,top='+ (window.screen.availHeight-30-150)/2 +',left='+ (window.screen.availWidth-10-150)/2);
		}
	</script>
</body>
</html>