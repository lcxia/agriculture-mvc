                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 活动参与者列表
                                </h2>
                            ...
                            <div class="box-content">
                                ...
                                <table
									...
									<tbody>
										<c:forEach var="specialInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${specialInfo.specialIp}</td>
												<td>${specialInfo.updateTime}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="delSpecial">
													<i class="glyphicon glyphicon-zoom-in icon-white"></i> 重置活动
												</a>
												&nbsp;&nbsp;&nbsp;&nbsp;
