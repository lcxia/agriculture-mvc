                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="distributorForm" action="editDistributor" method="post">
                                	<form:hidden path="distributorId" value="${distributorForm.distributorId}" />
                                	<div class="alert alert-info">${message}<form:errors path="*"></form:errors></div>
                                    <table class="table table-bordered responsive">
                                        <tr>
                                        	<td style="background-color: #f9f9f9;">登录名</td>
											<td><span>${distributorForm.distributorId}</span></td>
											<td style="background-color: #f9f9f9;">类型</td>
											<td>
												<div class="controls">
													<form:select path="type" itemValue="${distributorForm.type}">
											...
											<td>
												<div class="controls">
													<form:select path="level" itemValue="${distributorForm.level}">
										...
										<tr>
											...
											<td style="background-color: #f9f9f9;">打印名称<span style="color:red;">*</span></td>
											<td><form:input path="printName" cssClass="form-control" cssErrorClass="form-control error" value="${distributorForm.printName}" /></td>
											<td style="background-color: #f9f9f9;">增量百分比</td>
											<td>
												<div class="controls">
													<form:select path="priceIncrement" itemValue="${distributorForm.priceIncrement}">
										...
										<tr>
											...
											<td>
												<form:select path="provinceId" itemValue="${distributorForm.provinceId}">
													<form:options id="provinceId" items="${provinceList}" itemLabel="label" itemValue="value"/>
												</form:select>
											</td>
											<td style="background-color: #f9f9f9;">市</td>
											<td>
												<form:select path="cityId" itemValue="${distributorForm.cityId}">
													<form:options id="cityId" items="${cityList}" itemLabel="label" itemValue="value" />
												</form:select>
											</td>
											<td style="background-color: #f9f9f9;">地址<span style="color:red;">*</span></td>
											<td><form:input path="address" cssClass="form-control" cssErrorClass="form-control error" value="${distributorForm.address}" /></td>
										</tr>
										<tr>
											<td style="background-color: #f9f9f9;">联系人<span style="color:red;">*</span></td>
											<td><form:input path="contacts" cssClass="form-control" cssErrorClass="form-control error" value="${distributorForm.contacts}" /></td>
											<td style="background-color: #f9f9f9;">传真<span style="color:red;">*</span></td>
											<td><form:input path="fax" cssClass="form-control" cssErrorClass="form-control error" value="${distributorForm.fax}" /></td>
											<td style="background-color: #f9f9f9;">固定电话<span style="color:red;">*</span></td>
											<td><form:input path="telephone" cssClass="form-control" cssErrorClass="form-control error" value="${distributorForm.telephone}" /></td>
										</tr>
										<tr>
											...
											<td><form:input path="email" cssClass="form-control" cssErrorClass="form-control error" value="${distributorForm.email}" /></td>
											<td style="background-color: #f9f9f9;">微信<span style="color:red;">*</span></td>
											<td><form:input path="wechat" cssClass="form-control" cssErrorClass="form-control error" value="${distributorForm.wechat}" /></td>
										</tr>
										<tr>
											<td style="background-color: #f9f9f9;">QQ<span style="color:red;">*</span></td>
											<td><form:input path="qq" cssClass="form-control" cssErrorClass="form-control error" value="${distributorForm.qq}" /></td>
											<td style="background-color: #f9f9f9;">支付宝账号<span style="color:red;">*</span></td>
											...
											<td><input name="note" class="form-control" value="${distributorForm.note}" /></td>
										</tr>
                                    </table>
                                    <div class="input-group has-success col-md-12" align="right">
                                        <button type="submit" class="btn btn-success">提 交</button>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                       <a href="initDistributor" class="btn btn-danger">取消</a>
                                    </div>
