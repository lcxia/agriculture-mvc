                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 分销商密码
                                </h2>
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="distributorForm" action="editDistributorPassword" method="post">
                                	<div class="alert alert-info">${message}<form:errors path="*"></form:errors></div>
                                    <table class="table table-bordered responsive">
                                        <tr>
                                        	<td style="background-color: #f9f9f9;">原密码<span style="color:red;">*</span></td>
											<td><form:input type="password" path="password" cssClass="form-control" cssErrorClass="form-control error"/></td>
											<td style="background-color: #f9f9f9;">新密码<span style="color:red;">*</span></td>
											<td><form:input type="password" path="passwordNew" cssClass="form-control" cssErrorClass="form-control error"/></td>
											<td style="background-color: #f9f9f9;">密码确认<span style="color:red;">*</span></td>
                                    ...
                                    <div class="input-group has-success col-md-12" align="right">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                         <a href="initMenu" class="btn btn-danger">取消</a>
                                    </div>
