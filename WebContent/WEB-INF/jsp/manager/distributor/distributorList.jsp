                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 分销商列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="distributorsInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${distributorsInfo.distributorId}</td>
												<td>${distributorsInfo.type}</td>
												<td>${distributorsInfo.level}</td>
												<td>${distributorsInfo.distributorName}</td>
												<td>${distributorsInfo.contacts}</td>
												<td>${distributorsInfo.mobile}</td>
												<td>${distributorsInfo.email}</td>
												<td class="center"><a class="btn btn-success"
													href="initDistributorPrice?distributorId=${distributorsInfo.distributorId}"> <i
														class="glyphicon glyphicon-zoom-in icon-white"></i> 价格
												</a> <a class="btn btn-info" href="initEditDistributor?distributorId=${distributorsInfo.distributorId}"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 编辑
												</a> <a class="btn btn-danger" onclick="showDialog('delDistributor?distributorId=${distributorsInfo.distributorId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddDistributor">
