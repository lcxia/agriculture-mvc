                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 快递单信息
                                </h2>
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="expressListForm" action="addExpressList" method="post">
                                    ...
                                    <table class="table table-bordered responsive">
                                        <tr>
											<td style="background-color: #f9f9f9;">所属快递公司</td>
											<td>
												<div class="controls">
										...
										<tr>
											<td style="background-color: #f9f9f9;">快递单号开始<span style="color:red;">*</span></td>
											<td><form:input path="expressListIdStart" cssClass="form-control" cssErrorClass="form-control error"/></td>
											<td style="background-color: #f9f9f9;">快递单号结束<span style="color:red;">*</span></td>
                                    ...
                                    <div class="input-group has-success col-md-12" align="right">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                         <a href="initExpressList" class="btn btn-danger">取消</a>
                                    </div>
