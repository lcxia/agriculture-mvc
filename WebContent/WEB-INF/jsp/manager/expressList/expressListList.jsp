                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 快递单号列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="expressListInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${expressListInfo.expressName}</td>
												<td>${expressListInfo.expressListId}</td>
												<td>${expressListInfo.isUsed}</td>
												<td>${expressListInfo.orderId}</td>
												<td>${expressListInfo.usedDate}</td>
												<td>${expressListInfo.note}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddExpressList">
