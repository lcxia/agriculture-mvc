                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 终端价格
                                </h2>
                                ...
                                <form:form modelAttribute="distributorPriceForm" action="editDistributorPrice" method="post">
                                    ...
                                    <table class="table table-bordered responsive">
										<tr>
											...
											<input type="hidden" name="commodityName" value="${distributorPriceForm.commodityName}"/>
											<td>${distributorPriceForm.commodityName}</td>
											<td style="background-color: #f9f9f9;">指导价</td>
											<input type="hidden" name="guidePrice" value="${distributorPriceForm.guidePrice}"/>
											<td>${distributorPriceForm.guidePrice}</td>
											<td style="background-color: #f9f9f9;">终端价</td>
                                    ...
                                    <div class="input-group has-success col-md-12" align="right">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                       <a class="btn btn-danger" href="initDistributorPriceEdit">取消</a>
                                    </div>
