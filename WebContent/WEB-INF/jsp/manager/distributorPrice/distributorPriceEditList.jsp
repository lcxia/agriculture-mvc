										...
										<c:forEach var="distributorPricesInfo" items="${list}"
											...
											<tr>
												...
												<td><a class="btn btn-info"
													href="initEditDistributorPrice?commodityId=${distributorPricesInfo.commodityId}"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 修改
												</a><a class="btn btn-info"
													href="download?commodityId=${distributorPricesInfo.commodityId}"> <i
