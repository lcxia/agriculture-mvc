                            ...
                            <div class="box-content">
                                <table class="table table-bordered responsive">
                              		<tr>
										...
										<td>${distributorForm.distributorId}</td>
										<td style="background-color: #f9f9f9;">类型</td>
										<td>${distributorForm.type}</td>
										<td style="background-color: #f9f9f9;">等级</td>
										<td>${distributorForm.level}</td>
									</tr>
									<tr>
										<td style="background-color: #f9f9f9;">名称</td>
										<td>${distributorForm.distributorName}</td>
										<td style="background-color: #f9f9f9;">打印名称</td>
										<td>${distributorForm.printName}</td>
										<td style="background-color: #f9f9f9;">增量百分比</td>
										<td>${distributorForm.priceIncrement}</td>
									</tr>
									<tr>
										<td style="background-color: #f9f9f9;">省</td>
										<td>${distributorForm.provinceName}</td>
										<td style="background-color: #f9f9f9;">市</td>
										<td>${distributorForm.cityName}</td>
										<td style="background-color: #f9f9f9;">地址</td>
										<td>${distributorForm.address}</td>
									</tr>
									<tr>
										<td style="background-color: #f9f9f9;">联系人</td>
										<td>${distributorForm.contacts}</td>
										<td style="background-color: #f9f9f9;">传真</td>
										<td>${distributorForm.fax}</td>
										<td style="background-color: #f9f9f9;">固定电话</td>
										<td>${distributorForm.telephone}</td>
									</tr>
									<tr>
										<td style="background-color: #f9f9f9;">移动电话</td>
										<td>${distributorForm.mobile}</td>
										<td style="background-color: #f9f9f9;">Email</td>
										<td>${distributorForm.email}</td>
										<td style="background-color: #f9f9f9;">微信</td>
										<td>${distributorForm.wechat}</td>
									</tr>
									<tr>
										<td style="background-color: #f9f9f9;">QQ</td>
										<td>${distributorForm.qq}</td>
										<td style="background-color: #f9f9f9;">支付宝账号</td>
										<td>${distributorForm.alipay}</td>
										<td style="background-color: #f9f9f9;">备注</td>
										<td>${distributorForm.note}</td>
									</tr>
                            	</table>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 该分销商各商品价格列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="distributorPricesInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${distributorPricesInfo.type}</td>
												<td>${distributorPricesInfo.supplierName}</td>
												<td>${distributorPricesInfo.brandName}</td>
												<td>${distributorPricesInfo.specifications}</td>
												<td>${distributorPricesInfo.commodityName}</td>
												<td>${distributorPricesInfo.benchmarkPrice}</td>
												<td>${distributorPricesInfo.guidePrice}</td>
												<td>${distributorPricesInfo.retailPrice}</td>
												<td>${distributorPricesInfo.isGift}</td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
								<div class="input-group has-success col-md-12" align="right">
                                    <button type="button" onclick="window.history.back();" class="btn btn-danger">返回</button>
                                </div>
                            </div>
                        </div>
                    </div>
