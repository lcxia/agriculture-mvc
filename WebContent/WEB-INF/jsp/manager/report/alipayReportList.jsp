                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 支付宝对账单
                                </h2>
                            ...
                            <div class="box-content" style="overflow:auto;">
                                <table
									class="table table-striped table-bordered bootstrap-datatable datatable responsive" style="WIDTH:2500px;">
									<thead>
										<tr>
											<th>商户订单号</th>
											<th>订单名称</th>
									...
									<tbody>
										<c:forEach var="alipayReportsInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${alipayReportsInfo.outTradeNo}</td>
												<td>${alipayReportsInfo.subject}</td>
												<td>${alipayReportsInfo.price}</td>
												<td>${alipayReportsInfo.body}</td>
												<td>${alipayReportsInfo.receiveName}</td>
												<td>${alipayReportsInfo.receiveAddress}</td>
												<td>${alipayReportsInfo.receivePhone}</td>
												<td>${alipayReportsInfo.receiveMobile}</td>
												<td>${alipayReportsInfo.guestId}</td>
												<td>${alipayReportsInfo.isPaid}</td>
												<td>
													<c:if test="${alipayReportsInfo.isPaid !='true'}">
														<a class="btn btn-info"
															href="delAlipayReport?outTradeNo=${alipayReportsInfo.outTradeNo}"> <i
