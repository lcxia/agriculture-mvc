                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 快递商各地价格信息
                                </h2>
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="expressPriceForm" action="addExpressPrice" method="post">
                                    ...
                                    <table class="table table-bordered responsive">
                                        <tr>
											...
											<td><form:input path="separateWeight" cssClass="form-control" cssErrorClass="form-control error"/></td>
											<td style="background-color: #f9f9f9;">首重费（元）<span style="color:red;">*</span></td>
											<td><form:input path="firstHeavyPrice" cssClass="form-control" cssErrorClass="form-control error"/></td>
										</tr>
										<tr>
											<td style="background-color: #f9f9f9;">续重费（元）<span style="color:red;">*</span></td>
											<td><form:input path="continuedHeavyPrice" cssClass="form-control" cssErrorClass="form-control error"/></td>
                                    ...
                                    <div class="input-group has-success col-md-12" align="right">
                                        ...
                                        &nbsp;&nbsp;&nbsp;&nbsp;                                     
                                        <a href="initExpressPrice?expressId=${expressPriceForm.expressId}" class="btn btn-danger">取消</a>
                                    </div>
