                                ...
                                <form:form modelAttribute="expressPriceForm" action="editExpressPrice" method="post">
                                    ...
                                    <table class="table table-bordered responsive">
                                        <tr>
											...
											<!-- <td><input name="firstHeavyPrice" class="form-control" value="${expressPriceForm.firstHeavyPrice}" /></td> -->
										...
										<tr>
											...
											<td><input name="note" class="form-control" value="${expressPriceForm.note}" /></td>
										</tr>
                                    </table>
                                    <div class="input-group has-success col-md-12" align="right">                                       
                                        <button type="submit" class="btn btn-success">提 交</button>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                                        <a type="button" href="initExpressPrice?expressId=${expressPriceForm.expressId}" class="btn btn-danger">取 消</a>
                                    </div>
