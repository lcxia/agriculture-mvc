                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 供应商列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="suppliersInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${suppliersInfo.type}</td>
												<td>${suppliersInfo.level}</td>
												<td>${suppliersInfo.supplierName}</td>
												<td>${suppliersInfo.contacts}</td>
												<td>${suppliersInfo.mobile}</td>
												<td>${suppliersInfo.email}</td>
												<td class="center"><a class="btn btn-success"
													href="initBrand?supplierId=${suppliersInfo.supplierId}"> <i
														class="glyphicon glyphicon-zoom-in icon-white"></i> 详细
												</a> <a class="btn btn-info" href="initEditSupplier?supplierId=${suppliersInfo.supplierId}"> <i
														class="glyphicon glyphicon-edit icon-white"></i> 编辑
												</a> <a class="btn btn-danger" onclick="showDialog('delSupplier?supplierId=${suppliersInfo.supplierId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
									...
									<table>
										<tr>
											<td colspan="11" align="right">
												<a class="btn btn-success" href="initAddSupplier">
