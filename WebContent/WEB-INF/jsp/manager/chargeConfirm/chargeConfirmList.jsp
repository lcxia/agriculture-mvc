                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 充值列表
                                </h2>
                            ...
                            <div class="box-content">
                                <table
									...
									<tbody>
										<c:forEach var="chargeConfirmsInfo" items="${list}"
											varStatus="sts">
											<tr>
												<td>${chargeConfirmsInfo.chargeId}</td>
												<td>${chargeConfirmsInfo.amount}</td>
												<td>${chargeConfirmsInfo.distributorId}</td>
												<td>${chargeConfirmsInfo.chargeDate}</td>
												<td>${chargeConfirmsInfo.status}</td>
												<td class="center">
													<c:if test="${chargeConfirmsInfo.status == '已送审' || chargeConfirmsInfo.status == '已支付'}">
														<a class="btn btn-danger" onclick="showDialog('editChargeConfirm?chargeId=${chargeConfirmsInfo.chargeId}')" href="#" data-toggle="modal" data-target="#myModal"> <i
															class="glyphicon glyphicon-zoom-in icon-white"></i> 充值
														</a>
													</c:if>
												</td>
											</tr>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						...
						<a id="modalLink" href="delCar" class="btn btn-primary">充值</a>
					</div>
				</div>
			</div>
		</div>
