                    ...
                    <div class="box col-md-12">
                        <div class="box-inner">
                            <div class="box-header well" data-original-title="">
                                <h2>
                                    <i class="glyphicon glyphicon-edit"></i> 城市信息
                                </h2>
                            ...
                            <div class="box-content">
                                <form:form modelAttribute="cityForm" action="addCity" method="post">
                                    ...
                                    <table class="table table-bordered responsive">
                                        <tr>
                                        	<td style="background-color: #f9f9f9;">所属省</td>
											<td>
												<div class="controls">
											...
											<td style="background-color: #f9f9f9;">城市名称<span style="color:red">*</span></td>
											<td><form:input path="cityName" cssClass="form-control" cssErrorClass="form-control error" ></form:input></td>
										</tr>
                                    </table>
